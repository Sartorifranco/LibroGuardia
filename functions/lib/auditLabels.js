/**
 * Etiquetas legibles para auditoría / actividad (español operativo).
 */
...
const formatActionLabel = (action) => ACTION_LABELS[action] || String(action || 'Acción').replace(/\./g, ' · ');

const resolveTargetName = (item = {}) => {
...
const formatTargetLabel = (targetTypeOrItem, targetIdMaybe) => {
...
const buildReadableChanges = (before = null, after = null, changedKeys = null) => {
