...
## Empezá por acá (instalador)

- **[MANUAL-INSTALADOR.md](./MANUAL-INSTALADOR.md)** — documento único de referencia: arquitectura, catálogos de hardware, estaciones/bridges, checklist de cliente nuevo y mapa de archivos.
