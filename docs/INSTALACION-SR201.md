...
- [ ] Apagar el backend Node/Mongo en planta si aún corre (`pm2 stop/delete bacarguard-api` — ver `docs/MIGRACION-BACKEND.md` — Parte 1 (Apagado en planta)). *Independiente del pulso SR201: los datos Mongo ya están descartados; el apagado del proceso es una confirmación operativa.*
