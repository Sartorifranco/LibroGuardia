...
| API Node+Mongo (`bacarguard-api`) | `legacy/backend-libro-guardia` | **Sí** — descartado (sin migración); apagar en planta con los comandos de `MIGRACION-BACKEND.md` — Parte 1 |
...
| `apiBaseUrl` | Sí | Base API, sin barra final de más: `https://mss-guard.web.app/api` |
...
- [ ] `apiBaseUrl` apunta a producción (`https://mss-guard.web.app/api`)
